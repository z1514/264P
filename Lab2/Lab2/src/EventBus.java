...
public class EventBus {
    ...
    /**
     * Command event #7 definition: check whether the courses conflict before registering a student for a course.
     */
    public static final int EV_CONFLICT_CHECK = 7;

    /**
     * Command event #8 definition: check whether a course is overbooked before checking conflicts and registering a student for a course.
     */
    public static final int EV_OVERBOOK_CHECK = 8;
