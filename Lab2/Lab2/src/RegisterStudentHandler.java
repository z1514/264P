...
public class RegisterStudentHandler extends CommandEventHandler {
     ...
     * Although some codes in execute are modified to receive conflict flag,
     * the program still follow implicit invocation architectural
     * pattern. The modifications are done to help register handler
     * deal with separating conflict checking codes.
     *
    ...
    protected String execute(String param) {
        ...
        /**
         * This is added to receive conflict flag.
         */
        String conflictFlag = objTokenizer.nextToken();
        ...
        /**
         * The conflict check code is replaced with checking the flag.
         */
        // Check if the given course conflicts with any of the courses the student has registered.
        if (conflictFlag.equals("conflict"))
        {
