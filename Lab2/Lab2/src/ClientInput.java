        ...
        try {
            ...
            while (true) {
                ...
                if (sChoice.equals("6")) {
                    ...
                    /** Add the announcement for overbook check before conflicts checking and registering */
                    // Announce the command event #8 with course ID, and course section to check whether the course is overbooked.
                    // If not, the ClientOutput will print an empty string, otherwise, it will output "This course is overbooked"
                    EventBus.announce(EventBus.EV_SHOW, "\n");
                    EventBus.announce(EventBus.EV_OVERBOOK_CHECK, sCID + " " + sSection);

                    /**
                     * Change the event from register event to conflict event.
                     * After finishing conflict checking, the conflict handler will announce register event#6
                     * and send the original sSID, sCID and sSection with a conflict flag.
                     * The details are in CourseConflictHandler class.
                     */
